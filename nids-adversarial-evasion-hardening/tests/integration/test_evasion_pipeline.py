...
class TestEvasionPipeline:
    def test_full_pipeline(self):
        ...
        results = engine.evaluate_robustness(
            ...
            lambda d, l: engine.fgsm_attack(d, l, epsilon=0.3)
        )
        ...
        hardened_results = hardened_engine.evaluate_robustness(
            test_data, test_labels,
            lambda d, l: hardened_engine.fgsm_attack(d, l, epsilon=0.3)
        )
    ...
    def test_pgd_pipeline(self):
        ...
        results = engine.evaluate_robustness(
            test_data, test_labels,
            lambda d, l: engine.pgd_attack(d, l, epsilon=0.1, alpha=0.01, iterations=10)
        )
    ...
    def test_attack_then_harden_then_evaluate(self):
        ...
        pgd_results = engine.evaluate_robustness(
            test_data, test_labels,
            lambda d, l: engine.pgd_attack(d, l, epsilon=0.2, alpha=0.02, iterations=15)
        )
