    ...
    def compare_models(self, baseline_path, hardened_path, test_data, test_labels):
        ...
        comparison = {
            ...
            'robustness_improvement': (
                hardened_results['adversarial_accuracy'] -
                baseline_results['adversarial_accuracy']
            ),
            'evasion_reduction': (
                baseline_results['evasion_rate'] -
                hardened_results['evasion_rate']
            )
        }
